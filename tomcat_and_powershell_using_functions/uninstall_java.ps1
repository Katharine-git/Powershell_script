function GetUninstallString($productName) {
    ...
    function UninstallJava ($name) {
        ...
        UninstallJava 'Java SE Development Kit 8 Update 311'
        UninstallJava 'Java SE Development Kit 8 Update 311 (64-bit)'
        UninstallJava 'Java 8 Update 311'
        UninstallJava 'Java 8 Update 311 (64-bit)'